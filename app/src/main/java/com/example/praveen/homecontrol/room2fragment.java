...
//        ids.add(String.valueOf(linearlayout.getId())+10);
        ...
        view = inflater.inflate(R.layout.room2fragment, container, false);
        relativeLayout = ((RelativeLayout) view.findViewById(R.id.room2frg));
        linearlayout = ((LinearLayout) view.findViewById(R.id.linearlayout2));
        preferences = getContext().getSharedPreferences("Light_Info2", MODE_PRIVATE);
        ids = preferences.getStringSet("lights_ids2", ids);
        preferences2 = getContext().getSharedPreferences("data_info2", MODE_PRIVATE);
        database = FirebaseDatabase.getInstance();



        density = getContext().getResources().getDisplayMetrics().density;
        add = view.findViewById(R.id.addview2);
        temp = view.findViewById(R.id.temp2);
        door = view.findViewById(R.id.door2);
...
//                    Log.d("button:-", String.valueOf(v.getId()));
            ...
            textView[s].setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    editor.clear();
                    editor.commit();
                    editor.putInt("No_of_light2", k - 1);
                    editor.putStringSet("lights_ids2", ids);
                    if (ids.size() > 0) {
                        i = linearlayout.getId();
...
//                    JSONObject obj = new JSONObject(mssg);
                    ...
                    mssg = preferences2.getString("datas2", mssg);
